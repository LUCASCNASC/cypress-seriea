export class FutebolFemininoPage {

    //clicar no submenu Elenco
    clickElenco() {
        cy.get('.ct-submenu > .mt-3 > :nth-child(2) > a')
            .should("be.visible")
        cy.contains("Elenco")
            .should("be.visible")
        cy.get('.ct-submenu > .mt-3 > :nth-child(2) > a')
    ...
    validateElenco() {
        cy.get(':nth-child(6) > .container > :nth-child(1)')
            .should("be.visible")
            .and("contain.text", "Goleiras")
    }

    //clicar no submenu Estrutura
    clickEstrutura() {
        cy.get('.ct-submenu > .mt-3 > :nth-child(3) > a')
            .should("be.visible")
    ...
    validateEstrutura() {
        cy.get('header > h1')
            .should("be.visible")
            .and("contain.text", "Estrutura do Futebol Feminino")
    }

    //clicar no submenu Calendário de Jogos
    clickCalendarioJogos() {
        cy.get('.ct-submenu > .mt-3 > :nth-child(4) > a')
            .should("be.visible")
    ...
    validateCalendarioJogos() {
        cy.get('header > h1')
            .should("be.visible")
            .and("contain.text", "Calendário de jogos - Futebol Feminino")
    }

    //clicar no submenu Notícias
    clickNoticias() {
        cy.get('.ct-submenu > .mt-3 > :nth-child(5) > a')
            .should("be.visible")
